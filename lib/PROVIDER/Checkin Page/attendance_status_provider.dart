...
//   final String checkinTime;      // raw ISO string
...
//   /// Formatted check-in time — e.g. "07:04 AM"
//   String get checkInTimeFormatted {
//     if (_status == null || _status!.checkinTime.isEmpty) return '--:--';
//     try {
//       final dt = DateTime.parse(_status!.checkinTime).toLocal();
...
//   /// Total hours — trims seconds, e.g. "00:00:00" → "00:00"
//   String get totalHoursFormatted {
//     if (_status == null) return '00:00';
//     final parts = _status!.totalWorkingHours.split(':');
//     if (parts.length >= 2) return '${parts[0]}:${parts[1]}';
//     return _status!.totalWorkingHours;
//   }

//   /// Check-out time — '--:--' until the user has actually checked out today
//   String get checkOutTimeFormatted {
//     if (_status == null || !_status!.hasCheckedOutToday) return '--:--';
//     // If backend ever returns checkout_time, parse it here.
//     // For now, surface '--:--' until API provides it.
//     return '--:--';
//   }
...
class AttendanceStatusProvider extends ChangeNotifier {
  ...
  String _computeCheckoutTime(String checkinIso, String durationStr) {
    ...
    try {
      ...
      final checkout = dt.add(Duration(
        hours: hours,
        minutes: minutes,
        seconds: seconds,
      ));
