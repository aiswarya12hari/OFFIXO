  ...
  void initState() {
    ...
    Future.microtask(() async {
      await Future.wait([
        ...
        context.read<LeaveProvider>().fetchLeaveTypes(),
      ]);
    });
  }
    ...
    return Scaffold(
      ...
      body: RefreshIndicator(
        ...
        onRefresh: () async {
          await Future.wait([
            context.read<LeaveBalanceProvider>().fetchBalances(),
            context.read<LeaveProvider>().fetchLeaveTypes(forceRefresh: true),
          ]);
        },
          ...
          child: Column(
            ...
            children: [
              ...
              Consumer<LeaveProvider>(
                builder: (context, provider, _) {
                  if (provider.isLeaveTypesLoading) {
                    return const LeaveTypeDropdownShimmer();
                  }
                  ...
                  return Container(
                    ...
                    child: DropdownButtonHideUnderline(
                      child: DropdownButton<int>(
                        ...
                        items: provider.leaveTypes.map((LeaveTypeModel leave) {
      ...
      bottomNavigationBar: SafeArea(
        child: Container(
          padding: EdgeInsets.fromLTRB(
            AppStyle.responsiveWidth(context, 20),
            16,
            AppStyle.responsiveWidth(context, 20),
            16,
          ),
          decoration: BoxDecoration(
            color: AppStyle.whiteColor,
            border: Border(top: BorderSide(color: AppStyle.borderColor)),
          ),
              ...
              return SizedBox(
                ...
                child: ElevatedButton(
                  ...
                  style: ElevatedButton.styleFrom(
                    backgroundColor: AppStyle.primaryColor,
                    disabledBackgroundColor: AppStyle.primaryColor.withOpacity(
                      0.6,
                    ),
                    shape: RoundedRectangleBorder(
                      borderRadius: BorderRadius.circular(12),
