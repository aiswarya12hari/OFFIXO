...
//         final isOnBreak = provider.isOnBreak; // ✅ Toggle UI based on state

//         return GestureDetector(
//           onTap: provider.isLoading
//               ? null
//               : () => isOnBreak
//                     ? _submitEndBreak(context) // ✅ PATCH - end break
//                     : _showBreakDialog(context), // POST - start break
//           child: Container(
//             padding: const EdgeInsets.symmetric(horizontal: 24, vertical: 12),
//             decoration: BoxDecoration(
//               // ✅ Different color when on break
//               color: isOnBreak
